...
public class NonaDragonRenderer extends EntityRenderer<NonaDragon> {

    public NonaDragonRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.shadowRadius = 0.5F;
        this.model = new NonaDragonModel(context.bakeLayer(ModelLayers.ENDER_DRAGON));
    }
    ...
    private static final ResourceLocation DRAGON_EXPLODING_LOCATION = new ResourceLocation(DragonRace.MODID, "textures/entity/nona_dragon/dragon_exploding.png");
    private static final ResourceLocation DRAGON_LOCATION = new ResourceLocation(DragonRace.MODID, "textures/entity/nona_dragon/dragon.png");
    private static final ResourceLocation DRAGON_EYES_LOCATION = new ResourceLocation(DragonRace.MODID, "textures/entity/nona_dragon/dragon_eyes.png");
    ...
    private final NonaDragonModel model;


    public void render(NonaDragon dragon, float p_114209_, float p_114210_, PoseStack poseStack, MultiBufferSource p_114212_, int p_114213_) {
        poseStack.pushPose();
        float f = (float) dragon.getLatencyPos(7, p_114210_)[0];
        float f1 = (float) (dragon.getLatencyPos(5, p_114210_)[1] - dragon.getLatencyPos(10, p_114210_)[1]);
        ...
        this.model.prepareMobModel(dragon, 0.0F, 0.0F, p_114210_);
        if (dragon.dragonDeathTime > 0) {
            ...
            this.model.renderToBuffer(poseStack, vertexconsumer, p_114213_, OverlayTexture.NO_OVERLAY, 1.0F, 1.0F, 1.0F, f2);
            VertexConsumer vertexconsumer1 = p_114212_.getBuffer(DECAL);
            this.model.renderToBuffer(poseStack, vertexconsumer1, p_114213_, OverlayTexture.pack(0.0F, flag), 1.0F, 1.0F, 1.0F, 1.0F);
        } else {
            VertexConsumer vertexconsumer3 = p_114212_.getBuffer(RENDER_TYPE);
            this.model.renderToBuffer(poseStack, vertexconsumer3, p_114213_, OverlayTexture.pack(0.0F, flag), 1.0F, 1.0F, 1.0F, 1.0F);
        }

        VertexConsumer vertexconsumer4 = p_114212_.getBuffer(EYES);
        this.model.renderToBuffer(poseStack, vertexconsumer4, p_114213_, OverlayTexture.NO_OVERLAY, 1.0F, 1.0F, 1.0F, 1.0F);
        if (dragon.dragonDeathTime > 0) {
            float f5 = ((float) dragon.dragonDeathTime + p_114210_) / 200.0F;
        ...
        if (dragon.nearestCrystal != null) {
            poseStack.pushPose();
            float f6 = (float) (dragon.nearestCrystal.getX() - Mth.lerp((double) p_114210_, dragon.xo, dragon.getX()));
            float f8 = (float) (dragon.nearestCrystal.getY() - Mth.lerp((double) p_114210_, dragon.yo, dragon.getY()));
            float f9 = (float) (dragon.nearestCrystal.getZ() - Mth.lerp((double) p_114210_, dragon.zo, dragon.getZ()));
            renderCrystalBeams(f6, f8 + EndCrystalRenderer.getY(dragon.nearestCrystal, p_114210_), f9, p_114210_, dragon.tickCount, poseStack, p_114212_, p_114213_);
            poseStack.popPose();
        }

        super.render(dragon, p_114209_, p_114210_, poseStack, p_114212_, p_114213_);
    }
    ...
    public ResourceLocation getTextureLocation(NonaDragon p_114206_) {
    ...
    @OnlyIn(Dist.CLIENT)
    public static class NonaDragonModel extends EntityModel<NonaDragon> {
        ...
        @Nullable
        private NonaDragon entity;
        private float a;

        public NonaDragonModel(ModelPart p_173976_) {
        ...
        public void prepareMobModel(NonaDragon dragon, float p_114270_, float p_114271_, float p_114272_) {
            this.entity = dragon;
            this.a = p_114272_;
        }

        public void setupAnim(NonaDragon dragon, float p_114275_, float p_114276_, float p_114277_, float p_114278_, float p_114279_) {
        }

        public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int p_114283_, int p_114284_, float p_114285_, float p_114286_, float p_114287_, float p_114288_) {
            poseStack.pushPose();
            ...
            poseStack.translate(0.0D, (double) (f1 - 2.0F), -3.0D);
            ...
            for (int i = 0; i < 5; ++i) {
                ...
                this.neck.render(poseStack, vertexConsumer, p_114283_, p_114284_, 1.0F, 1.0F, 1.0F, p_114288_);
            }
            ...
            this.head.render(poseStack, vertexConsumer, p_114283_, p_114284_, 1.0F, 1.0F, 1.0F, p_114288_);
            poseStack.pushPose();
            poseStack.translate(0.0D, 1.0D, 0.0D);
            poseStack.mulPose(Vector3f.ZP.rotationDegrees(-f6 * 1.5F));
            poseStack.translate(0.0D, -1.0D, 0.0D);
            this.body.zRot = 0.0F;
            this.body.render(poseStack, vertexConsumer, p_114283_, p_114284_, 1.0F, 1.0F, 1.0F, p_114288_);
            ...
            this.renderSide(poseStack, vertexConsumer, p_114283_, p_114284_, f1, this.leftWing, this.leftFrontLeg, this.leftFrontLegTip, this.leftFrontFoot, this.leftRearLeg, this.leftRearLegTip, this.leftRearFoot, p_114288_);
            this.renderSide(poseStack, vertexConsumer, p_114283_, p_114284_, f1, this.rightWing, this.rightFrontLeg, this.rightFrontLegTip, this.rightFrontFoot, this.rightRearLeg, this.rightRearLegTip, this.rightRearFoot, p_114288_);
            poseStack.popPose();
