...
public class NonaDragonSittingFlamingPhase extends AbstractNonaDragonSittingPhase {
    ...
    public NonaDragonSittingFlamingPhase(NonaDragon dragon) {
        super(dragon);
    }
    ...
    public NonaDragonPhase<NonaDragonSittingFlamingPhase> getPhase() {
        return NonaDragonPhase.SITTING_FLAMING;
    }
