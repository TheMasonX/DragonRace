...
public class NonaDragonChargePlayerPhase extends AbstractNonaDragonPhaseInstance {
    ...
    public NonaDragonChargePlayerPhase(NonaDragon p_31206_) {
        super(p_31206_);
    }
    ...
    public NonaDragonPhase<NonaDragonChargePlayerPhase> getPhase() {
        return NonaDragonPhase.CHARGING_PLAYER;
    }
}