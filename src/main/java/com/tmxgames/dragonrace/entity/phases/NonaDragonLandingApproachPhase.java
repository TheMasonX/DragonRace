...
public class NonaDragonLandingApproachPhase extends AbstractNonaDragonPhaseInstance {
    ...
    public NonaDragonLandingApproachPhase(NonaDragon dragon) {
        super(dragon);
    }

    public NonaDragonPhase<NonaDragonLandingApproachPhase> getPhase() {
        return NonaDragonPhase.LANDING_APPROACH;
    }
    ...
    private void findNewTarget() {
        ...
        if (this.currentPath != null && this.currentPath.isDone()) {
            this.dragon.getPhaseManager().setPhase(NonaDragonPhase.LANDING);
        }
