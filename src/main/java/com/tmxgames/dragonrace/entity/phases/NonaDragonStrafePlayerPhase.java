...
public class NonaDragonStrafePlayerPhase extends AbstractNonaDragonPhaseInstance {
    ...
    public NonaDragonStrafePlayerPhase(NonaDragon dragon) {
        super(dragon);
    }
    ...
    public NonaDragonPhase<NonaDragonStrafePlayerPhase> getPhase() {
        return NonaDragonPhase.STRAFE_PLAYER;
    }
}