...
public class NonaDragonSittingScanningPhase extends AbstractNonaDragonSittingPhase {
    ...
    public NonaDragonSittingScanningPhase(NonaDragon p_31342_) {
        super(p_31342_);
    ...
    public void doServerTick() {
        ...
        if (livingentity != null) {
            if (this.scanningTime > 25) {
                this.dragon.getPhaseManager().setPhase(NonaDragonPhase.SITTING_ATTACKING);
            } else {
            ...
            this.dragon.getPhaseManager().setPhase(NonaDragonPhase.TAKEOFF);
            if (livingentity != null) {
                this.dragon.getPhaseManager().setPhase(NonaDragonPhase.CHARGING_PLAYER);
                this.dragon.getPhaseManager().getPhase(NonaDragonPhase.CHARGING_PLAYER).setTarget(new Vec3(livingentity.getX(), livingentity.getY(), livingentity.getZ()));
            }
        }
    ...
    public NonaDragonPhase<NonaDragonSittingScanningPhase> getPhase() {
        return NonaDragonPhase.SITTING_SCANNING;
    }
}