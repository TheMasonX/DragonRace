...
public class NonaDragonDeathPhase extends AbstractNonaDragonPhaseInstance {
    @Nullable
    private Vec3 targetLocation;
    private int time;

    public NonaDragonDeathPhase(NonaDragon dragon) {
        super(dragon);
    }
    ...
    public NonaDragonPhase<NonaDragonDeathPhase> getPhase() {
        return NonaDragonPhase.DYING;
    }
}
