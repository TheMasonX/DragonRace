...
public class NonaDragonHoldingPatternPhase extends AbstractNonaDragonPhaseInstance {
    ...
    public NonaDragonHoldingPatternPhase(NonaDragon dragon) {
        super(dragon);
    }

    public NonaDragonPhase<NonaDragonHoldingPatternPhase> getPhase() {
        return NonaDragonPhase.HOLDING_PATTERN;
    }
    ...
    private void findNewTarget() {
        if (this.currentPath != null && this.currentPath.isDone()) {
            ...
            if (this.dragon.getRandom().nextInt(i + 3) == 0) {
                this.dragon.getPhaseManager().setPhase(NonaDragonPhase.LANDING_APPROACH);
                return;
            }
    ...
    private void strafePlayer(Player p_31237_) {
        this.dragon.getPhaseManager().setPhase(NonaDragonPhase.STRAFE_PLAYER);
        this.dragon.getPhaseManager().getPhase(NonaDragonPhase.STRAFE_PLAYER).setTarget(p_31237_);
    }
